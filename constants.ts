...
// Coin Rewards
export const COIN_REWARD_NORMAL = 1;
export const COIN_REWARD_STRONG = 2;
export const COIN_REWARD_FAST = 3;
export const BOSS_BASE_COIN_REWARD = 20;
export const BOSS_PHASE_COIN_BONUS = 10;

// Revival System
export const REVIVAL_KEY_SPAWN_INTERVAL_MS = 180000; // 3 minutes
export const REVIVAL_KEY_SIZE = { width: 30, height: 50 };
export const REVIVAL_KEY_SPEED = 2;
export const REVIVE_SCREEN_DURATION_MS = 5000;
export const REVIVE_INVINCIBILITY_DURATION_MS = 3000;
export const REVIVE_HULL_RESTORE_PERCENTAGE = 0.5;
